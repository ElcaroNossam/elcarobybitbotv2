...
from blockchain.chain import EnlikoChain, ConsensusEngine, generate_address, elc_to_wei
from blockchain.dex import EnlikoDEX, OrderSide, OrderType, PositionSide
from blockchain.bridge import EnlikoBridge, BridgeChain, BridgeRelayer
from blockchain.governance import EnlikoDAO, VoteOption, ProposalType
...
def demo_blockchain_basics():
    ...
    # Initialize chain
    chain = EnlikoChain(chain_id=1, block_time=2, max_validators=100)
