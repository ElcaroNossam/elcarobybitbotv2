...
```
app/src/main/java/io/lyxen/trading/
...
1. Create keystore:
```bash
keytool -genkey -v -keystore lyxen-release.keystore -alias lyxen -keyalg RSA -keysize 2048 -validity 10000
```

2. Add to `local.properties`:
```properties
RELEASE_STORE_FILE=lyxen-release.keystore
RELEASE_STORE_PASSWORD=your_password
RELEASE_KEY_ALIAS=lyxen
