...
/**
 * Biometric Authentication Manager for Lyxen Trading
 * ===================================================
 * 
...
class BiometricAuthManager(private val context: Context) {
    ...
    companion object {
        private const val KEY_NAME = "lyxen_biometric_key"
    ...
    suspend fun authenticate(
        ...
        subtitle: String = "Authenticate to access Lyxen Trading",
