...
// Enliko Brand Colors (Synced with WebApp - Stark Theme)
val EnlikoPrimary = Color(0xFFDC2626)      // Red - primary accent
val EnlikoPrimaryDark = Color(0xFF991B1B)  // Dark red
val EnlikoSecondary = Color(0xFFD4A017)    // Gold - secondary accent
val EnlikoAccent = Color(0xFF00D4FF)       // Cyan - utility accent
