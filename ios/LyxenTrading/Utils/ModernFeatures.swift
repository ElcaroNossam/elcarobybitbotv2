...
/**
 * Modern Features Module for Lyxen Trading iOS App
 * =================================================
 * 
...
class BiometricAuthManager: ObservableObject {
    ...
    /// Аутентификация
    func authenticate(reason: String = "Authenticate to access Lyxen Trading") async -> BiometricResult {
...
struct AnimatedCounter: Animatable, View {
    ...
    init(value: Double, format: String = "%.2f", font: Font = .body, color: Color = .primary) {
        self.value = value
        self.format = format
        self.font = font
        self.color = color
