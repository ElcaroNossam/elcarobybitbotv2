...
TEXTS = {
    ...
    'position_closed': (
        '📊 *Position Closed* {side_emoji} {side_display}\n'
        '━━━━━━━━━━━━━━━━\n'
        '🪙 `{symbol}` • {strategy}\n'
        '🟢 Entry: `{entry:.6g}`\n'
        '🔴 Exit: `{exit:.6g}`\n'
        '📏 Size: `{size:.4g}` • Margin: `{margin:.2f} USDT` ({leverage}x)\n'
        '━━━━━━━━━━━━━━━━\n'
        '📊 Price Δ: `{pct:+.2f}%`\n'
        '💰 Gross P/L: `{pnl:+.2f} USDT`\n'
        '💸 Fee: `-{fee:.4f} USDT`\n'
    ...
    'oi_closed': (
        '🐋 *OI Closed* {side_emoji} {side_display}\n'
        '━━━━━━━━━━━━━━━━\n'
        '🪙 `{symbol}`\n'
        '🟢 Entry: `{entry:.6g}`\n'
        '🔴 Exit: `{exit:.6g}`\n'
    ...
    'scryptomera_closed': (
        '🔮 *Scryptomera Closed* {side_emoji} {side_display}\n'
        '━━━━━━━━━━━━━━━━\n'
        '🪙 `{symbol}`\n'
        '🟢 Entry: `{entry:.6g}`\n'
        '🔴 Exit: `{exit:.6g}`\n'
    ...
    'scalper_closed': (
        '⚡ *Scalper Closed* {side_emoji} {side_display}\n'
        '━━━━━━━━━━━━━━━━\n'
        '🪙 `{symbol}`\n'
        '🟢 Entry: `{entry:.6g}`\n'
        '🔴 Exit: `{exit:.6g}`\n'
    ...
    'elcaro_closed': (
        '🔥 *Enliko Closed* {side_emoji} {side_display}\n'
        '━━━━━━━━━━━━━━━━\n'
        '🪙 `{symbol}`\n'
        '🟢 Entry: `{entry:.6g}`\n'
        '🔴 Exit: `{exit:.6g}`\n'
    ...
    'fibonacci_closed': (
        '📐 *Fibonacci Closed* {side_emoji} {side_display}\n'
        '━━━━━━━━━━━━━━━━\n'
        '🪙 `{symbol}`\n'
        '🟢 Entry: `{entry:.6g}`\n'
        '🔴 Exit: `{exit:.6g}`\n'
    ...
    'rsi_bb_closed': (
        '📊 *RSI+BB Closed* {side_emoji} {side_display}\n'
        '━━━━━━━━━━━━━━━━\n'
        '🪙 `{symbol}`\n'
        '🟢 Entry: `{entry:.6g}`\n'
        '🔴 Exit: `{exit:.6g}`\n'
