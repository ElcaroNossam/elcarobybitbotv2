...
TEXTS = {
    ...
    # Auto notifications
    'new_position':                '🚀 Nueva posición {symbol} @ {entry:.6f}, tamaño={size}',
    ...
    # Entries & errors
    'oi_limit_entry':              '🟡 Entrada Limit por OI {symbol} @ {price:.6f}',
    'oi_limit_error':              '❌ Error en entrada Limit: {msg}',
    'oi_market_entry':             '🚀 Entrada Market por OI {symbol} @ {price:.6f}',
    'oi_market_error':             '❌ Error en entrada Market: {msg}',

    'rsi_bb_limit_entry':          '🟡 Entrada Limit por RSI+BB {symbol} @ {price:.6f}',
    'rsi_bb_market_entry':         '✅ Market por RSI+BB {symbol} @ {price:.6f}',
    'rsi_bb_market_error':         '❌ Error en Market: {msg}',

    'oi_analysis':                 '📊 *Análisis OI de {symbol}* {side}',

    # Scryptomera
    'bitk_limit_entry':            '🔮 Entrada Limit (Scryptomera) {symbol} @ {price:.6f}',
    'bitk_limit_error':            '❌ Error Limit (Scryptomera): {msg}',
    'bitk_market_entry':           '🔮 Market (Scryptomera) {symbol} @ {price:.6f}',
    'bitk_market_error':           '❌ Error Market (Scryptomera): {msg}',
    ...
    'wyckoff_limit_entry':         '📐 Wyckoff entrada límite {symbol} @ {price:.6f}',
    'wyckoff_limit_error':         '❌ Wyckoff error entrada límite: {msg}',
    'wyckoff_market_entry':        '🚀 Wyckoff mercado {symbol} @ {price:.6f}',
    'wyckoff_market_error':        '❌ Wyckoff error mercado: {msg}',
    ...
    # Elcaro AI settings
    'elcaro_ai_note': '🤖 *¡La IA hace el trabajo por ti!*',
    'elcaro_ai_params_header': 'Lo siguiente se analiza de cada señal:',
    'elcaro_ai_params_list': '• SL% • TP% • ATR • Apalancamiento • Marco temporal',
...
✅ Todas las actualizaciones futuras''',
    'premium_1m': '💎 1 Mes — {price}⭐',
    'premium_3m': '💎 3 Meses — {price}⭐ (-15%)',
    'premium_6m': '💎 6 Meses — {price}⭐ (-25%)',
    'premium_12m': '💎 12 Meses — {price}⭐ (-35%)',
    
    # Basic plan
    'basic_title': '🥈 *PLAN BASIC*',
    'basic_desc': '''✅ Acceso completo a cuenta demo
✅ Cuenta real: solo estrategias OI, RSI+BB, Elcaro
❌ Scryptomera, Scalper — solo demo
✅ Soporte estándar
✅ SL/TP dinámico basado en ATR''',
    'basic_1m': '🥈 1 Mes — {price}⭐',
...
🎁 Solo una vez''',
    ...
    'btn_pay_ton': '💎 TON',
    'payment_stars_title': '⭐ Pago via Telegram Stars',
    'payment_stars_desc': 'Se te cobrará {amount}⭐ por {plan} ({period}).',
