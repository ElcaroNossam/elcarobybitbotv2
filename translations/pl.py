...
TEXTS = {
    ...
    # Auto notifications
    'new_position':                '🚀 Nowa pozycja {symbol} @ {entry:.6f}, rozmiar={size}',
    ...
    # Entries & errors
    'oi_limit_entry':              '🟡 OI wejście Limit {symbol} @ {price:.6f}',
    'oi_limit_error':              '❌ Błąd wejścia Limit: {msg}',
    'oi_market_entry':             '🚀 OI wejście Market {symbol} @ {price:.6f}',
    'oi_market_error':             '❌ Błąd wejścia Market: {msg}',

    'rsi_bb_limit_entry':          '🟡 RSI+BB wejście Limit {symbol} @ {price:.6f}',
    'rsi_bb_market_entry':         '✅ RSI+BB Market {symbol} @ {price:.6f}',
    'rsi_bb_market_error':         '❌ Błąd Market: {msg}',

    'oi_analysis':                 '📊 *Analiza OI {symbol}* {side}',

    # Scryptomera
    'bitk_limit_entry':            '🔮 Scryptomera Limit {symbol} @ {price:.6f}',
    'bitk_limit_error':            '❌ Błąd Scryptomera Limit: {msg}',
    'bitk_market_entry':           '🔮 Scryptomera Market {symbol} @ {price:.6f}',
    'bitk_market_error':           '❌ Błąd Scryptomera Market: {msg}',
...
✅ Wszystkie przyszłe aktualizacje''',
    'premium_1m': '💎 1 Miesiąc — {price}⭐',
    'premium_3m': '💎 3 Miesiące — {price}⭐ (-15%)',
    'premium_6m': '💎 6 Miesięcy — {price}⭐ (-25%)',
    'premium_12m': '💎 12 Miesięcy — {price}⭐ (-35%)',
    
    'basic_title': '🥈 *PLAN BASIC*',
    'basic_desc': '''✅ Pełny dostęp do konta demo
✅ Prawdziwe konto: tylko strategie OI, RSI+BB, Elcaro
❌ Scryptomera, Scalper — tylko demo
✅ Standardowe wsparcie
✅ Dynamiczny SL/TP oparty na ATR''',
    'basic_1m': '🥈 1 Miesiąc — {price}⭐',
...
🎁 Tylko raz''',
    ...
    'btn_pay_ton': '💎 TON',
    'payment_stars_title': '⭐ Płatność przez Telegram Stars',
    'payment_stars_desc': 'Zostaniesz obciążony {amount}⭐ za {plan} ({period}).',
