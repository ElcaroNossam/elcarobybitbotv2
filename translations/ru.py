...
TEXTS = {
    ...
    'welcome':                     '''🔥 *Добро пожаловать, Альфа-Трейдер!*

Пока ты читаешь это — *847 трейдеров* уже зарабатывают с ElCaro.

⚡ *< 100мс* скорость исполнения
🛡️ *664 теста безопасности* пройдено
💎 *24/7* AI-торговля без сна

_Твои конкуренты не спят. ElCaro тоже._

Выбери путь к финансовой свободе:''',
    'no_strategies':               '❌ Нет — _Каждую секунду без стратегий ты теряешь деньги_',
    'guide_caption':               '📚 *СЕКРЕТЫ ЭЛИТНЫХ ТРЕЙДЕРОВ*\n\n⚠️ Эта информация дала нашим топ-трейдерам *несправедливое преимущество*.\n\n_Время чтения: 3 мин. Потенциальный профит: безлимит._',
    'privacy_caption':             '📜 *Твоя безопасность = наша одержимость*\n\n🔐 Шифрование банковского уровня\n✅ Никаких утечек данных. Никогда.\n\n_Ты в надёжных руках._',
    'button_api':                  '🔑 Подключить API',
    'button_secret':               '🔒 Секретный ключ',
    'button_api_settings':         '🔑 Настройка API',
    'button_subscribe':            '💎 ПОЛУЧИТЬ PREMIUM ⚡',
    'button_licenses':             '🔑 Мой доступ',
    'button_admin':                '👑 Админ',
    'button_balance':              '💰 Мои профиты',
    'button_orders':               '📈 Активные сделки',
    'button_positions':            '📊 Моя империя',
    'button_history':              '📋 История побед',
    'button_strategies':           '🤖 AI Стратегии',
    'button_api_keys':             '🔑 Подключить биржу',
    'button_bybit':                '🟠 Bybit ⭐',
    'button_hyperliquid':          '🔷 HyperLiquid 🚀',
    'button_switch_bybit':         '🔄 Переключить на Bybit',
    'button_switch_hl':            '🔄 Переключить на HyperLiquid',
    'button_percent':              '🎚 Управление риском',
    'button_coins':                '💠 Выбор активов',
    'button_market':               '📉 Сканер рынка',
    'button_manual_order':         '✋ Снайперский ордер',
    'button_update_tpsl':          '🆕 Защита профита',
    'button_cancel_order':         '❌ Отменить',
    'button_limit_only':           '🎯 Режим точности',
    'button_toggle_oi':            '🔀 OI Трекер китов',
    'button_toggle_rsi_bb':        '📊 RSI+BB Сигналы',
    'button_scryptomera':          '🔮 Scryptomera AI',
    'button_scalper':              '🎯 Турбо Скальпер',
    'button_elcaro':               '🔥 Elcaro Heatmap',
    'button_fibonacci':            '📐 Fibonacci Мастер',
    'button_settings':             '📋 Боевой конфиг',
    'button_indicators':           '💡 Pro Индикаторы',
    'button_support':              '🆘 VIP Поддержка',
