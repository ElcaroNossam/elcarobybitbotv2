...
TEXTS = {
    ...
    'welcome':                     '''🔥 <b>Ласкаво просимо, Альфа-Трейдер!</b>

Поки ви читаєте це — <b>847 трейдерів</b> вже заробляють з ElCaro.

⚡ <b>&lt; 100ms</b> швидкість виконання
🛡️ <b>664 тести безпеки</b> пройдено
💎 <b>24/7</b> AI-трейдинг

<i>Ваші конкуренти не сплять. ElCaro теж.</i>

Оберіть шлях до фінансової свободи:''',
    'no_strategies':               '❌ Немає — <i>Ви втрачаєте гроші кожну секунду без активних стратегій</i>',
    'guide_caption':               '📚 <b>СЕКРЕТИ ЕЛІТНИХ Трейдерів</b>\n\n⚠️ Ця інформація дала нашим топ-трейдерам <b>нечесну перевагу</b>.\n\n<i>Час читання: 3 хв. Потенційний прибуток: безмежний.</i>',
    'privacy_caption':             '📜 <b>Ваша Безпека = Наша Одержимість</b>\n\n🔐 Банківське шифрування\n✅ Жодного обміну даними. Ніколи.\n\n<i>Ви в надійних руках.</i>',
