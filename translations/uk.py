...
Bybit • HyperLiquid • Мульти-стратегії''',
    ...
    # Indicators
    'indicators_header':           '📈 *Індикатори Enliko*',
    ...
    'new_position': (
        ...
        '<i>AI Enliko працює для вас 24/7</i>'
    ),
    ...
    # Enliko (Heatmap) - Вогняний стиль (ліквідність, зони пожежі)
    ...
    'be_settings_desc':              '_Перемістити SL до ціни входу коли прибуток досягне % активації_',
    'be_enabled_label':              '🔒 Беззбитковість',
    'be_trigger_label':              '🎯 Активація BE %',
    'prompt_be_trigger':             'Введіть % активації беззбитковості (напр. 1.0):',
    'prompt_long_be_trigger':        '📈 LONG Активація BE %\n\nВведіть % прибутку для переміщення SL до входу:',
    'prompt_short_be_trigger':       '📉 SHORT Активація BE %\n\nВведіть % прибутку для переміщення SL до входу:',
    'param_be_trigger':              '🎯 Активація BE %',
    'be_moved_to_entry':             '🔒 {symbol}: SL переміщено до беззбитковості @ {entry}',
    'be_status_enabled':             '✅ BE: {trigger}%',
    'be_status_disabled':            '❌ BE: Вимкнено',

    # Partial Take Profit settings UI
    'partial_tp_label':              '✂️ Часткове TP',
    'partial_tp_status_enabled':     '✅ Часткове TP увімкнено',
    'partial_tp_status_disabled':    '❌ Часткове TP вимкнено',
    'partial_tp_step1_menu':         '✂️ *Часткове TP - Крок 1*\n\nЗакрити {close}% позиції при +{trigger}% прибутку\n\n_Виберіть параметр:_',
    'partial_tp_step2_menu':         '✂️ *Часткове TP - Крок 2*\n\nЗакрити {close}% позиції при +{trigger}% прибутку\n\n_Виберіть параметр:_',
    'trigger_pct':                   'Активація',
    'close_pct':                     'Закрити',
    'prompt_long_ptp_1_trigger':     '📈 LONG Крок 1: % Активації\n\nВведіть % прибутку для закриття першої частини:',
    'prompt_long_ptp_1_close':       '📈 LONG Крок 1: % Закриття\n\nВведіть % позиції для закриття:',
    'prompt_long_ptp_2_trigger':     '📈 LONG Крок 2: % Активації\n\nВведіть % прибутку для закриття другої частини:',
    'prompt_long_ptp_2_close':       '📈 LONG Крок 2: % Закриття\n\nВведіть % позиції для закриття:',
    'prompt_short_ptp_1_trigger':    '📉 SHORT Крок 1: % Активації\n\nВведіть % прибутку для закриття першої частини:',
    'prompt_short_ptp_1_close':      '📉 SHORT Крок 1: % Закриття\n\nВведіть % позиції для закриття:',
    'prompt_short_ptp_2_trigger':    '📉 SHORT Крок 2: % Активації\n\nВведіть % прибутку для закриття другої частини:',
    'prompt_short_ptp_2_close':      '📉 SHORT Крок 2: % Закриття\n\nВведіть % позиції для закриття:',
...
✅ Всі 5 стратегій: OI, RSI+BB, Scryptomera, Scalper, Enliko
...
✅ Всі майбутні оновлення''',
    ...
    'premium_3m': '💎 3 Місяці — {price} ELC (-10%)',
    'premium_6m': '💎 6 Місяців — {price} ELC (-20%)',
    'premium_12m': '💎 12 Місяців — {price} ELC (-30%)',
    
    # Basic plan
    'basic_title': '🥈 *БАЗОВИЙ ПЛАН*',
    'basic_desc': '''✅ Повний доступ до демо-акаунту
✅ Реальний акаунт: OI, RSI+BB, Scryptomera, Scalper
❌ Enliko, Fibonacci, Spot — лише Premium
...
🎁 Лише один раз''',
    ...
    'btn_pay_ton': '💎 TON',
    'payment_elc_title': ' Оплата через ELC',
    'payment_elc_desc': 'З вас буде списано {amount} ELC за {plan} ({period}).',
...
''',
    ...
    'payment_elc_insufficient': '''❌ Недостатньо балансу ELC.
...
Поповніть гаманець для продовження.''',
    ...
    'wallet_balance': '''💰 *Ваш ELC Гаманець*

◈ Баланс: *{balance} ELC*
📈 У стейку: *{staked} ELC*
🎁 Очікуючі винагороди: *{rewards} ELC*
...
📍 1 ELC = 1 USDT''',
    ...
    'wallet_deposit_desc': '''Надішліть ELC токени на адресу вашого гаманця:

`{address}`

💡 *Демо режим:* Натисніть нижче, щоб отримати безкоштовні тестові токени.''',
    'wallet_deposit_success': '''✅ Успішно поповнено {amount} ELC!''',
   ...
   {date}''',
    ...
    'wallet_stake_desc': '''Застейкайте свої ELC токени та отримуйте *12% річних*!

💰 Доступно: {available} ELC
📈 Зараз у стейку: {staked} ELC
🎁 Очікуючі винагороди: {rewards} ELC

Щоденні винагороди • Миттєве виведення''',
    'wallet_stake_success': '''✅ Успішно застейкано {amount} ELC!''',
    'wallet_stake_title': '''📈 *Стейкінг ELC*''',
    'wallet_title': '''◈ *ELC Гаманець*''',
    'wallet_unstake_success': '''✅ Виведено {amount} ELC + {rewards} ELC винагород!''',
...
👉 Deposit funds to resume trading.""",
    ...
    # =====================================================
    'error_insufficient_balance': '💰 Недостатньо коштів на рахунку для відкриття позиції. Поповніть баланс або зменшіть розмір позиції.',
    'error_order_too_small': '📉 Розмір ордера занадто малий (мінімум $5). Збільшіть Entry% або поповніть баланс.',
    'error_api_key_expired': '🔑 API ключ прострочений або недійсний. Оновіть API ключі в налаштуваннях.',
    'error_api_key_missing': '🔑 API ключі не налаштовані. Додайте ключі Bybit в меню 🔗 API Keys.',
    'error_rate_limit': '⏳ Забагато запитів. Зачекайте хвилину і спробуйте знову.',
    'error_position_not_found': '📊 Позиція не знайдена або вже закрита.',
    'error_leverage_error': '⚙️ Помилка встановлення плеча. Спробуйте встановити плече вручну в терміналі біржі.',
    'error_network_error': '🌐 Проблема з мережею. Спробуйте пізніше.',
    'error_sl_tp_invalid': '⚠️ Неможливо встановити SL/TP: ціна занадто близька до поточної. SL/TP будуть оновлені при наступному циклі.',
    'error_equity_zero': '💰 На рахунку нульовий баланс. Поповніть Demo або Real рахунок для торгівлі.',
    
    # =====================================================
    # HARDCODED STRINGS FIX (Jan 27, 2026)
    # =====================================================
    'terminal_button': '💻 Термінал',
    'exchange_mode_activated_bybit': '🟠 *Режим Bybit активовано*',
    'exchange_mode_activated_hl': '🔷 *Режим HyperLiquid активовано*',
    'error_processing_request': '⚠️ Помилка обробки запиту',
    'unauthorized_admin': '❌ Не авторизовано. Ця команда лише для адміністратора.',
    'error_loading_dashboard': '❌ Помилка завантаження панелі.',
    'unauthorized': '❌ Не авторизовано.',
    'processing_blockchain': '⏳ Обробка блокчейн транзакції...',
    'verifying_payment': '⏳ Перевірка платежу в блокчейні TON...',
    'no_wallet_configured': '❌ Гаманець не налаштовано.',
    'use_start_menu': 'Використайте /start для повернення до головного меню.',
}
