...
Deletes all snapshots older than 1 hour to keep the database size manageable.

Usage:
    python manage.py cleanup_old_snapshots
    python manage.py cleanup_old_snapshots --hours 2  # Custom retention period
"""
...
class Command(BaseCommand):
    help = "Delete ScreenerSnapshot records older than specified hours (default: 1)"
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            ...
            type=int,
            default=1,
            help="Delete snapshots older than this many hours (default: 1)",
        )
        parser.add_argument(
            "--dry-run",
            action="store_true",
