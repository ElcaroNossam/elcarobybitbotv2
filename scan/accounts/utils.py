        ...
        <tr>
            <td align="center" style="padding: 20px 0;">
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="background-color: #1f2833; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.5);">
                    <!-- Header -->
                    <tr>
                        <td style="background: linear-gradient(135deg, #ff4d8a 0%, #ff80cc 100%); padding: 30px 40px; text-align: center;">
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            <h2 style="margin: 0 0 20px 0; color: #ff80cc; font-size: 24px; font-weight: 600;">Здравствуйте, {user.username}!</h2>
                            
                            <p style="margin: 0 0 20px 0; color: #c5c6c7; font-size: 16px; line-height: 1.6;">
                                Спасибо за регистрацию на <strong style="color: #ff80cc;">Noet-Dat</strong>! 
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                <tr>
                                    <td align="center" style="padding: 20px 0;">
                                        <a href="{verification_url}" style="display: inline-block; padding: 16px 40px; background: linear-gradient(135deg, #ff4d8a 0%, #ff80cc 100%); color: #0b0c10; text-decoration: none; border-radius: 6px; font-size: 16px; font-weight: 600; letter-spacing: 0.5px; box-shadow: 0 4px 15px rgba(255, 128, 204, 0.3);">
                                            Подтвердить email
                                        </a>
                                    </td>
                                </tr>
                            ...
                            <p style="margin: 10px 0 0 0; word-break: break-all;">
                                <a href="{verification_url}" style="color: #ff80cc; text-decoration: underline; font-size: 14px;">{verification_url}</a>
                            </p>
                        </td>
                    </tr>
                    ...
                    <!-- Footer -->
                    <tr>
                        <td style="background-color: #0b0c10; padding: 30px 40px; text-align: center; border-top: 1px solid #ff4d8a33;">
